...
QString Encryption::Hash(QString Data)
{
    try
    {
...
QString Encryption::HexHash(QString Data)
{
    try
    {
...
QString Encryption::Encode(QString Data)
{
    try
    {
...
QString Encryption::Decode(QString Data)
{
    try
    {
...
QString Encryption::Encrypt(QString Data)
{
    try
    {
...
QString Encryption::Decrypt(QString Data)
{
    try
    {
        //Setup the key derive functions
...
bool Encryption::EncryptFile(QString Source, QString Destination)
{
    try
    {
...
bool Encryption::DecryptFile(QString Source, QString Destination)
{
    try
    {
        Source = Source.remove("\"");
...
void Encryption::setSalt(QString Salt)
{
